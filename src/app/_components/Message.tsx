...
export default function MessageView({ message }: { message: Message }) {
    return (
        <>
        <div className={"mx-3 max-w-full w-full text-base-content message message-" + message.type + (message.type == MessageType.SYSTEM ? " p-4 m-1 bg-base-200/50 border border-info rounded-badge" : "")}>
